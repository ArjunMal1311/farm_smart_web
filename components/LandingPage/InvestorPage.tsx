...
const InvestorPage = () => {
    ...
    return (
        <div className='mt-16 flex justify-center items-center flex-col'>
            <div className='text-4xl font-bold text-center'>Optimize Your Farm Returns with <span className='inline-block bg-clip-text text-transparent bg-gradient-to-l from-[#46ce31] to-[#4a822c]'>FarmSmart</span></div>
            <div className='mt-4 text-center md:w-2/3 lg:w-1/3 px-8 font-medium text-[18px]'>Empower your farm's financial future with FarmSmart investment tools. Effortlessly plan and optimize your agricultural investments, making informed decisions tailored for the farming community.</div>
